package com.tianma315.wx.social.service.impl;
...
public class JdbcConnectionRepository implements ConnectionRepository {
    ...
    ServiceProviderConnectionMapper connectionMapper = new  ServiceProviderConnectionMapper();
