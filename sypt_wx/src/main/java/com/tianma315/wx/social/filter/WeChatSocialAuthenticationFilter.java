package com.tianma315.wx.social.filter;
 ...
 * @author Yuan Ji
 */
public class WeChatSocialAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public WeChatSocialAuthenticationFilter(AuthenticationManager authManager, UserIdSource userIdSource, UsersConnectionRepository usersConnectionRepository, SocialAuthenticationServiceLocator authServiceLocator) {
