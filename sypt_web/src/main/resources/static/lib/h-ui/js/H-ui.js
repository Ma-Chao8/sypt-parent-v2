...
(function(factory) {
	...
	$.fn.ajaxSubmit = function(options) {
		...
		// options.iframe allows user to force iframe model
		// 06-NOV-09: now defaulting to iframe model if file input is detected
...
! (function(factory) {
	...
	var Datetimepicker = function(element, options) {
		...
		if ('wheelViewModeNavigation' in options) {
			...
			this.wheelViewModeNavigation = this.element.data('views-model-wheel-navigation');
		}
		...
		if ('wheelViewModeNavigationInverseDirection' in options) {
			...
			this.wheelViewModeNavigationInverseDirection = this.element.data('views-model-wheel-navigation-inverse-dir');
		}
		...
		if ('wheelViewModeNavigationDelay' in options) {
			...
			this.wheelViewModeNavigationDelay = this.element.data('views-model-wheel-navigation-delay');
		}
