$(function () {
        ...
        series : [
            {
                name:'大码',
                type:'bar',
                data:[10, 49, 70, 232, 256, 767, 435, 462, 326, 200, 64, 33],
                markPoint : {
                    data : [
                        {type : 'max', name: '最大值'},
                        {type : 'min', name: '最小值'}
            ...
            },
            {
                name:'小码',
                type:'bar',
                data:[26, 59, 90, 264, 287, 707, 475, 482, 487, 188, 60, 23],
                markPoint : {
                    data : [
                        // {name : '年最高', value : 707, xAxis: 5, yAxis: 183, symbolSize:18},
    ...
    var pieId = document.getElementById('echarts-scatter-chart');
    if (!pieId){
        return false;
    }
