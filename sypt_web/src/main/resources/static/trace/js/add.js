...
$(function () {
    ...
    function renderImgList(datas) {
        ...
        for (var i in  datas) {
            ...
            var text = '<li>' +
                '    <div class="f-l pl-20">' +
                '        <img name="' + record.id + '" src="'+record.url+'" onclick="picboost(' + record.url + ')">' +
                '    </div>' +
                '    <div class="f-r pr-20">' +
                '        <input name="1" type="button" draggable="true" value="增加" class="btn btn-success radius">' +
                '        <input name="2" type="button" draggable="true" value="替换" class="btn btn-primary radius ml-10">' +
                '    </div>' +
                '</li>';
