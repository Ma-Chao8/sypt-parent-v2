...
import com.tianma315.core.sys.domain.ColumnDO;
import com.tianma315.core.sys.domain.TableDO;
...
public class GenUtils {
    public static String AUTO_REMOVE_PRE = "true"; //删除前缀
